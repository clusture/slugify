...
var get_slug_default = getSlug;

// src/common/logger.ts
var import_chalk = __toModule(require_source());
var warn = (...args) => console.warn(import_chalk.default.yellow(...args));
...
var getTitle = async () => {
  ...
  const ans = await new Promise((resolve) => {
    const msg = import_chalk2.default.green(`title: `);
    rl.question(msg, (inp) => {
      resolve(inp);
      rl.close();
    });
...
(async () => {
  ...
  const slug = get_slug_default(title);
  warn(" slug:", slug);
  console.log();
})();
